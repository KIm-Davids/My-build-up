...
import java.util.Arrays;
	public class ArrayQuestionNumeber14 {
		...
		if(collectInput[0] % 2 == 0 && collectInput[1] % 2 == 0) {
		movedNumber[0] = collectInput[1];
		movedNumber[1] = collectInput[0];
		}
		
		if(collectInput[2] % 2 == 0 && collectInput[3] % 2 == 0) {
		movedNumber[3] = collectInput[2];
		movedNumber[2] = collectInput[3];
		}

		if(collectInput[4] % 2 == 0 && collectInput[5] % 2 == 0){
